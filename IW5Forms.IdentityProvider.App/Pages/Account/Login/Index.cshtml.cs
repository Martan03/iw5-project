...
namespace IW5Forms.IdentityProvider.App.Pages.Login;

[SecurityHeaders]
[AllowAnonymous]
public class Index : PageModel
{
    private readonly IAppUserFacade _appUserFacade;
    ...
    public async Task<IActionResult> OnPost()
    {
        ...
        if (ModelState.IsValid)
        {
            ...
            if (await _appUserFacade.ValidateCredentialsAsync(Input.Username, Input.Password))
            {
                var user = await _appUserFacade.GetUserByUserNameAsync(Input.Username);
